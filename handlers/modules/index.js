...
const bots = botTokens.map((token, index) => {
  ...
  client.on("interactionCreate", async (interaction) => {
    ...
    const detailsEmbed = new EmbedBuilder()
      .setTitle(`<a:ggeg1_944745994256438:1541881273658773504> تفاصيل الرد التلقائي - ${keyword}`)
      .addFields(
...
,   {
  ...
  client.on("guildCreate", async (guild) => {
    ...
    const embed = new EmbedBuilder()
      .setTitle("<a:ggeg1_944745994256438:1541881273658773504> New Guild Joined")
      .setColor(0x00ff00)
      .addFields(
  ...
  client.on("messageCreate", async (message) => {
    if (message.channel.type === ChannelType.DM && !message.author.bot) {
      ...
      const embed = new EmbedBuilder()
        .setTitle("<a:ggeg1_944745994256438:1541881273658773504> رسـالـه أرسـلـت لـلـبـوت")
      ...
      case "subs":
        {
          ...
          const embed = new EmbedBuilder()
            .setTitle("<a:ggeg1_944745994256438:1541881273658773504> اشتراكات البوتات")
            .setColor(0x5865f2)
            .setTimestamp();
  ...
  client.on("interactionCreate", async (i) => {
    ...
    const embed = new EmbedBuilder()
      .setTitle("<a:ggeg1_944745994256438:1541881273658773504> قائمة البوتات")
      .setColor(0x5865f2)
      .setTimestamp();
  ...
  client.on("interactionCreate", async (i) => {
    ...
    try {
      ...
      const embed = new EmbedBuilder()
        .setTitle("<a:ggeg1_944745994256438:1541881273658773504> تم تجديد الاشتراك")
        .setDescription(
      ...
      try {
        ...
        await ownerUser.send({
          embeds: [
            new EmbedBuilder()
              .setTitle("<a:ggeg1_944745994256438:1541881273658773504> تم تجديد اشتراك بوتك")
              .setDescription(
                ED.index_003({
                  PLAN_DURATIONS,
                  botName,
      ...
      if (alertCh) {
        await alertCh
          .send({
            embeds: [
              new EmbedBuilder()
                .setTitle("<a:ggeg1_944745994256438:1541881273658773504> تجديد اشتراك")
                .setDescription(
                  ED.index_004({
                    PLAN_DURATIONS,
                    botName,
          ...
          if (sub.status === "active" && now >= sub.expiresAt) {
            ...
            if (!sub.notifiedExpired) {
              ...
              const expiredEmbed = new EmbedBuilder()
                .setTitle("<a:ggeg1_944745994256438:1541881273658773504> انتهى اشتراك البوت")
            ...
            const deletedEmbed = new EmbedBuilder()
              .setTitle("<a:ggeg1_944745994256438:1541881273658773504> تم حذف بيانات البوت")
